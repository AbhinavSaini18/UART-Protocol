...
REM
REM Generated by Vivado on Wed Jun 03 19:55:45 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_uart_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_uart_top_vlog.prj -log xvlog.log
